...
var routes = [
    { path: '', children: [
            ...
            { path: 'child-detail', loadChildren: function() { return __webpack_require__.e/* import() */(6).then(__webpack_require__.bind(null, 225))  .then( function(module) { return module['ChildDetailModule']; } ); } }
        ] },
];
